...
export default function PrivateFlightPage() {
  ...
  const [mainImg, setMainImg] = useState('/images/private-main.png');
  return (
    <div className="min-h-screen bg-[#ecd3bb] flex flex-col items-center">
      <div className="w-full max-w-6xl mx-auto flex flex-col md:flex-row gap-8 mt-12 px-4">
        ...
        <div className="flex-1 flex flex-col items-center md:items-start">
          <h1 className="text-2xl md:text-3xl font-extrabold mb-4 mt-2 md:mt-0"><span className="font-black">PRIVATE</span> Flight in Marrakech</h1>
          <img src={mainImg} alt="Private main" className="w-full max-w-xl h-56 md:h-64 object-cover rounded-2xl mb-6" />
        ...
        <div className="w-full md:w-80 flex flex-col items-center bg-white rounded-2xl shadow-lg p-6 mt-4 md:mt-0">
          ...
          <div className="w-full flex flex-row justify-between items-center mb-4">
            ...
            <span className="text-3xl font-extrabold text-[#e74c3c]">$450</span>
          </div>
      ...
      <div className="w-full max-w-6xl mx-auto mt-12 px-4">
        ...
        <div className="text-base md:text-lg text-black/90 mb-6 max-w-3xl">
          <p className="mb-2">A Romantic Escape Above Marrakech</p>
          <p className="mb-2">We invite you to elevate your senses with an exclusive, tailor-made hot-air balloon flight—crafted for those who value privacy, comfort, and a hint of romance. Whether you're celebrating a special moment or simply escaping the everyday, this private journey offers a rare opportunity to drift peacefully above the captivating landscapes of Marrakech.</p>
          <p className="mb-2">Enjoy the intimacy of the moment as you float silently over Berber villages, rolling desert dunes, and the majestic Atlas Mountains—just you, the open sky, and the one you love. Every detail of your experience is designed to ensure complete privacy, luxurious comfort, and unforgettable memories.</p>
        </div>
        ...
        <ul className="list-disc pl-6 text-base md:text-lg text-black/80 mb-16">
          <li>Private round-trip transport in a high-end vehicle from your hotel or riad</li>
          <li>Exclusive welcome with Moroccan tea and refreshments in a private lounge</li>
          ...
          <li>A private 1-hour flight with panoramic views of the Atlas Mountains, Berber villages, and Moroccan desert</li>
          <li>Gourmet traditional breakfast, personalized just for you, featuring refined local speciaities.</li>
          <li>An invite-only flight certificate, personalized for you, as a keepsake of this extraordinary experience</li>
        </ul>
      </div>
